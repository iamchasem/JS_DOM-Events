...
node1.textContent = "I used getElementById('node1') method to access this";

// Select Node #2 and change the text to: "I used the getElementByClassName("node2") method to access this" */

let node2 = document.getElementsByClassName("node2")[0];

node2.textContent = "I used the getElementsByClassName('node2') to access this";
...
for (let element of allh3s) {
  element.textContent = "I used the getElementsbyTagName('h3') method to access this!"
}
...
newParagraph.textContent = "This node was created using thee createElement() method";
...
anchorEl.textContent = "I am an <a> tag";
...
parent.insertBefore(anchorEl, newParagraph);
